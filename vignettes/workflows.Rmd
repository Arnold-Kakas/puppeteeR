...
**Tip**: be explicit in the advisor's instructions about the reply format. The routing reads
for a response that starts with `"approved"` or `"revise:"` — a vague verdict like `"looks
good"` will be treated as a revision request.
